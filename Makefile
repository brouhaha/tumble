...
# Makefile
# $Id: Makefile,v 1.17 2003/03/04 17:58:36 eric Exp $
...
CSRCS = t2p.c semantics.c bitblt.c bitblt_test.c bitblt_table_gen.c \
	pdf.c pdf_util.c pdf_prim.c pdf_bookmark.c pdf_g4.c pdf_g4_table_gen.c
...
t2p: t2p.o scanner.o semantics.o parser.tab.o bitblt.o \
	pdf.o pdf_util.o pdf_prim.o pdf_bookmark.o pdf_g4.o
